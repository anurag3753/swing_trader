...
# cmd.sh
source /home/anurag3753/venv/bin/activate && cd /home/anurag3753/swing_trader && pip install -r requirements-new.txt && python manage.py process_stocks && python manage.py process_ma_stocks
